...
export enum MgControlName {
    AEOFF_RESULT_ENTRY2 = "AEOFF_RESULT_ENTRY2",
        Label1 = "Label1",
        Label2 = "Label2",
        ...
        Label14 = "Label14",
        Edit17 = "Edit17",
        V_PROGRESS1TEST = "V_PROGRESS1TEST",
        Label18 = "Label18",
        V_PROGRESS2TEST = "V_PROGRESS2TEST",
}
...
export class MgFormControlsAccessor {
    ...
    get V_PROGRESS1TEST(): FormControl {
        return this.fg.controls[MgControlName.V_PROGRESS1TEST] as FormControl;
    }

    get V_PROGRESS2TEST(): FormControl {
        return this.fg.controls[MgControlName.V_PROGRESS2TEST] as FormControl;
    }
