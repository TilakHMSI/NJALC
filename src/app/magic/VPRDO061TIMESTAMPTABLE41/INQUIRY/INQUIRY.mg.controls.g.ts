...
export enum MgControlName {
    INQUIRY = "INQUIRY",
        ...
        Table7 = "Table7",
        Column8 = "Column8",
        VPRDO064_WORK_W64_OPE_TYPE = "VPRDO064_WORK_W64_OPE_TYPE",
        Column9 = "Column9",
...
export class MgFormControlsAccessor {
    ...
    get VPRDO064_WORK_W64_OPE_TYPE(): FormControl {
        return this.getTableChildFormControl(MgControlName.VPRDO064_WORK_W64_OPE_TYPE);
    }
