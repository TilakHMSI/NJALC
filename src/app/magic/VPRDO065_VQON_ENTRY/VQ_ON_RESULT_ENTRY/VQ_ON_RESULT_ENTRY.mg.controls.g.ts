...
export enum MgControlName {
    VQ_ON_RESULT_ENTRY = "VQ_ON_RESULT_ENTRY",
        Table1 = "Table1",
        Column2 = "Column2",
        Edit9 = "Edit9",
...
export class MgFormControlsAccessor {
    ...
    get S5_VQON_DATE(): FormControl {
        return this.getTableChildFormControl(MgControlName.S5_VQON_DATE);
    }

    get S5_VQON_TIME(): FormControl {
        return this.getTableChildFormControl(MgControlName.S5_VQON_TIME);
    }
