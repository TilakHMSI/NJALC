...
export class MgFormControlsAccessor {
    ...
    get S5_VQOFF_DATE(): FormControl {
        return this.getTableChildFormControl(MgControlName.S5_VQOFF_DATE);
    }

    get S5_VQOFF_TIME(): FormControl {
        return this.getTableChildFormControl(MgControlName.S5_VQOFF_TIME);
    }

    get S5_QI_STAMP_NO(): FormControl {
        return this.getTableChildFormControl(MgControlName.S5_QI_STAMP_NO);
    }
