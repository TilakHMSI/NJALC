...
override ngOnInit(): void {
        ...
        (group.controls['vBlob64baseA'] as FormControl).registerOnChange(this.OnChange.bind(this));
        (group.controls['vBlob64baseB'] as FormControl).registerOnChange(this.OnChange.bind(this));
        (group.controls['vBlob64baseC'] as FormControl).registerOnChange(this.OnChange.bind(this));
      }
     ...
     OnChange() {
        if (
          ...
          this.mg.getValue('vBlob64baseA') !== undefined &&
          this.mg.getValue('vBlob64baseA') !== null,
          this.mg.getValue('vBlob64baseB') !== undefined &&
          this.mg.getValue('vBlob64baseB') !== null,
          this.mg.getValue('vBlob64baseC') !== undefined &&
          this.mg.getValue('vBlob64baseC') !== null
        ) {
          this.downloadblb2();
          this.downloadblb3();
          this.downloadblb4();
      ...
      downloadblb2() {
        ...
        if (base64 !== undefined || base64 !== null) {
         ...
         downloadblb3() {
        const base64 = this.mg.getValue('vBlob64baseA');
        if (base64 !== undefined || base64 !== null) {
          const byteCharacters = atob(base64);
          const byteNumbers = new Array(byteCharacters.length);
          ...
          if (binLb2.size !== 0) {
            const downloadlink = document.createElement('a');
            const filename = this.mg.getValue(this.mgc.vFileNameA);
            const linkSource = window.URL.createObjectURL(binLb2);
          ...
          downloadblb4() {
        const base64 = this.mg.getValue('vBlob64baseB');
        if (base64 !== undefined || base64 !== null) {
          const byteCharacters = atob(base64);
          const byteNumbers = new Array(byteCharacters.length);
          ...
          if (binLb2.size !== 0) {
            const downloadlink = document.createElement('a');
            const filename = this.mg.getValue(this.mgc.vFileNameB);
            const linkSource = window.URL.createObjectURL(binLb2);
          ...
          downloadblb5() {
        const base64 = this.mg.getValue('vBlob64baseC');
        if (base64 !== undefined || base64 !== null) {
          const byteCharacters = atob(base64);
          const byteNumbers = new Array(byteCharacters.length);
          ...
          if (binLb2.size !== 0) {
            const downloadlink = document.createElement('a');
            const filename = this.mg.getValue(this.mgc.vFileNameC);
            const linkSource = window.URL.createObjectURL(binLb2);
