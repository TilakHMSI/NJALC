...
export class VPRDB023_LFACTORYFRAMELIST249 extends TaskBaseMagicComponent {
    ...
    override createFormControlsAccessor(formGroup: FormGroup) {
       ...
       private static readonly formName: string = "VPRDB023_LFACTORYFRAMELIST249";
    ...
    X() {
        return VPRDB023_LFACTORYFRAMELIST249.x;
    }
    Y() {
        return VPRDB023_LFACTORYFRAMELIST249.y;
    }
    Width(): string {
        return VPRDB023_LFACTORYFRAMELIST249.width;
    }
    Height(): string {
        return VPRDB023_LFACTORYFRAMELIST249.height;
    }
    IsCenteredToWindow() {
        return VPRDB023_LFACTORYFRAMELIST249.isCenteredToWindow;
    }
    FormName() {
        return VPRDB023_LFACTORYFRAMELIST249.formName;
    }
    ShowTitleBar() {
        return VPRDB023_LFACTORYFRAMELIST249.showTitleBar;
    }
    ShouldCloseOnBackgroundClick() {
        return VPRDB023_LFACTORYFRAMELIST249.shouldCloseOnBackgroundClick;
    }
    IsResizable() {
        return VPRDB023_LFACTORYFRAMELIST249.isResizable;
    }
    IsMovable() {
        return VPRDB023_LFACTORYFRAMELIST249.isMovable;
    }
